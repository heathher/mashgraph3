...
BRIDGE_TARGETS = easybmp tinyobjloader inih

# Link libraries gcc flag: library will be searched with prefix "lib".
LDFLAGS = -leasybmp -ltinyobjloader -linih

# Add headers dirs to gcc search path
CXXFLAGS += -I $(INCLUDE_DIR) -I $(BRIDGE_INCLUDE_DIR) -I ../externals
# Add path with compiled libraries to gcc search path
CXXFLAGS += -L $(BRIDGE_LIBRARY_DIR) -DGLM_ENABLE_EXPERIMENTAL
...
clean:
	...
	rm -f bridge.touch $(BIN_DIR)/task3
